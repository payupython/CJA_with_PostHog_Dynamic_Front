-- Fix UNIQUE constraint: allow same URL with different event_dates
-- Change from UNIQUE(url) to UNIQUE(url, event_date)

PRAGMA foreign_keys=OFF;

-- Create new table with fixed constraint
